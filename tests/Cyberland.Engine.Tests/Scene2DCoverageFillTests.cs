...
/// <summary>Exercises remaining branches/paths for line coverage on Scene2D APIs.</summary>
public sealed class Scene2DCoverageFillTests
{
    ...
    [Fact]
    public void Scale2D_One_and_AsVector()
    {
        var s = Scale.One;
        Assert.Equal(1f, s.X);
    ...
    [Fact]
    public void Transform2D_Identity_values()
    {
    ...
    [Fact]
    public void Sprite2D_DefaultWhiteUnlit_populates()
    {
    ...
    {
        var w = new World();
        var h = Host(new RecordingRenderer2D());
        var o = ParOpts();
