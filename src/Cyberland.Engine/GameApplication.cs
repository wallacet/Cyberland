...
/// </para>
/// <para>
/// Core engine systems (transforms, triggers, sprite animation, particles; after mods: viewport anchors, lighting, post-process volumes, tilemaps, sprites, particles, text staging, bitmap text) register on the scheduler before and after <see cref="Modding.ModLoader.LoadAll"/>; mods add their own serial or parallel systems via <see cref="Modding.ModLoadContext.RegisterSerial"/> / <see cref="Modding.ModLoadContext.RegisterParallel"/>, implementing <see cref="Core.Ecs.IEarlyUpdate"/> / <see cref="Core.Ecs.IFixedUpdate"/> / <see cref="Core.Ecs.ILateUpdate"/> (or parallel equivalents) as needed.
/// </para>
/// <para>
