...
/// Vertical: for top presets, <see cref="ViewportAnchor2D.OffsetY"/> is inset from the top edge (screen space) or top in world space; for bottom presets, inset from the bottom edge.
/// </remarks>
public enum ViewportAnchorPreset
{
    /// <summary><see cref="ViewportAnchor2D.OffsetX"/> / <see cref="ViewportAnchor2D.OffsetY"/> from top-left (screen) or bottom-left (world) as appropriate.</summary>
    TopLeft,
