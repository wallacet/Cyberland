...
/// </summary>
/// <remarks>
/// Volume authoring is spawned from <c>Content/Scenes/hdr.json</c>; this system only mutates what must track resize + gameplay.
...
/// Bloom coefficients live on <see cref="BloomTuning"/> next to other HDR tuning constants.
/// </remarks>
public sealed class PostVolumeFillSystem : ISingletonSystem, ISingletonLateUpdate
{
    /// <inheritdoc cref="IEcsQuerySource.QuerySpec"/>
    public SystemQuerySpec QuerySpec => SystemQuerySpec.All<BloomVolumeTag, PostProcessVolumeSource, Transform>();

    private readonly GameHostServices _host;
    private EntityId _player;

    /// <summary>Creates the system.</summary>
    public PostVolumeFillSystem(GameHostServices host) => _host = host;
    ...
    public void OnSingletonLateUpdate(in SingletonEntity volume, float deltaSeconds)
    {
        ...
        var bloomGain = BloomTuning.GainAtPlayerLeft - BloomTuning.GainSpanAcrossPlayfield * tNorm;
