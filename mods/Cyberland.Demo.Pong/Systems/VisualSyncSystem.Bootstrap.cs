...
public sealed partial class VisualSyncSystem
{
    ...
    private void ConfigureTextRowsOnStart()
    {
        ConfigureTextRow(_t.Title, TitleStyle);
        ConfigureTextRow(_t.GameOverLine, GameOverStyle);
        ConfigureTextRow(_t.Hint, HintStyle);
        ConfigureTextRow(_t.ScoreYou, HudStyle);
