...
/// </summary>
/// <remarks>
/// <para><b>Scroll:</b> log stick-to-bottom uses a large <see cref="Cyberland.Engine.UI.Controls.UiScrollView.ContentOffset"/> Y value; a first-class <c>ScrollToEnd()</c> (and clamp) would be clearer.</para>
